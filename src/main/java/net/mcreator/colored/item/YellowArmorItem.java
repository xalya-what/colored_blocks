...
public abstract class YellowArmorItem extends ArmorItem {
	public YellowArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends YellowArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colored:textures/models/armor/yellow_layer_1.png";
		}
	}
	...
	public static class Leggings extends YellowArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "colored:textures/models/armor/yellow_layer_2.png";
		}
	}
